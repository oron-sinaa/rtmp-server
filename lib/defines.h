...
#define DTSH_PART_SIZE 18

#ifndef SHM_DATASIZE
#define SHM_DATASIZE 5
#endif
...
#define FLIP_DATA_PAGE_SIZE 2 * 1024 * 1024
#define FLIP_TARGET_DURATION 10000
...
#define SHM_STREAM_META_LEN 2 * 1024 * 1024
#define SHM_STREAM_META_ITEM 1024

#define SHM_STREAM_TM "MstTrak%s@%" PRIu32 "-%zu" //%s stream name
#define SHM_STREAM_TRACK_ITEM 128 * 1024
#define SHM_STREAM_TRACK_LEN SHM_STREAM_TRACK_ITEM

// Default values, these will scale up and down when needed, and are mainly used as starting values.
#define DEFAULT_TRACK_COUNT 10
...
#define DEFAULT_FRAGMENT_DURATION 1000

// Pages get marked for deletion after X seconds of no one watching
#define DEFAULT_PAGE_TIMEOUT 2
...
#define TRACK_TRACK_OFFSET 206
#define TRACK_TRACK_RECORDSIZE 1049572
...
#define TRACK_PART_RECORDSIZE 18
...
#define COMMS_USERS_INITSIZE 64 * 1024
...
#define SESS_TIMEOUT 30 // Session timeout in seconds
...
#define SHM_SESSIONS_SIZE 16400 // 16kB = almost 100 sessions
...
/// Traffic statistics
#define TRAFFIC_BUFFER_SIZE 200
#define TRAFFIC_NESTED_SIZE 100
#define USER_LIST "MstUserList"
#define USER_INITSIZE 50 * 1024
#define STREAM_LIST "MstStreamList"
#define STREAM_INITSIZE 50 * 1024
#define TRAFFIC_STATISTICS "MstTrafficStats"             // Shared pagename
#define TRAFFIC_ORG_STAQU "MstTrafficStaqu"
#define TRAFFIC_ORG_CLIENT "MstTrafficClient"
#define SEMAPHORE_LOCK_WRITE_MODE "MstTrafficWriteLock"  // Semaphore lock pagename
#define IS_UPDATED "isUpdated"                           // use to check is shared page data added in DB or not
#define TRAFFIC_STATISTICS_INITSIZE 200 * 1024 * 1024
#define DEFAULT_ROW_CAPACITY 1024 * 10
#define DEFAULT_DATETIME_CAPACITY 1000
#define DEFAULT_SESSION_COUNT 90 * 100
#define TRAFFIC_DATA_BUFFER 200
#define HLS_PROTOCOL_IDENTIFIER "HLS"
#define WS_PROTOCOL_IDENTIFIER "Raw/WS"
#define RECURSION_TRY 2
#define DATABASE_REGULATION 7
// Default timeout in seconds to transfer session bandwidth data to shared memory; otherwise, data shifts when the binary terminate
#define SESSION_TO_SHM_TIMEOUT (getenv("SESSION_TO_SHM_TIMEOUT") ? std::atoi(getenv("SESSION_TO_SHM_TIMEOUT")) : 30)
// Default timeout which shift the bandwidth data to database
#define SHM_TO_DB_TIMEOUT (getenv("SHM_TO_DB_TIMEOUT") ? std::atoi(getenv("SHM_TO_DB_TIMEOUT")) : 60)