...
namespace DTSC{
  ...
  public:
    ...
    uint64_t getTimestamp(size_t idx) const;
  ...
  private:
    ...
    Util::RelAccXFieldData isKeyframeField;
  };
  ...
  public:
    ...
    Util::RelAccXFieldData partsTimeField;
    Util::RelAccXFieldData partIsKeyframeField;
  ...
  public:
    ...
    void setMilliSyncMs(size_t trackIdx, const uint64_t &milliSyncMs);
    uint64_t getMilliSyncMs(size_t trackIdx) const;

    void setFirstRtpMs(size_t trackIdx, const uint32_t &firstRtpMs);
    uint64_t getFirstRtpMs(size_t trackIdx) const;
    ...
    bool removeFirstKey(size_t trackIdx, std::string streamName);
    ...
    size_t getFirstKeyPart(uint64_t timestamp, size_t idx) const;
    size_t getPrevToKeyPartTimeIndex(uint64_t timestamp, size_t idx) const;
  ...
  private:
    ...
    Util::RelAccXFieldData trackMilliSyncMsField;
    Util::RelAccXFieldData trackFirstRtpMsField;
  };
}// namespace DTSC
